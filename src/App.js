	...
	return (
		<div className="w-12/12">
			<div className="relative">
				<img className="w-screen h-screen" src={ floQastImage } alt="FloQast_Image" />
				<div className="absolute top-32 left-0.5 py-6 bg-gradient-to-r from-gray-100 to-transparent">
					<div className="ml-32 mb-2">
						<div className="relative">
							<img className="w-[20rem] opacity-100" src={ floQastLogo } alt="FloQast_Logo" />
							<i className="absolute top-8 right-[22rem] text-6xl font-bold text-gray-600">The</i>
							<i className="text-7xl font-bold text-green4">Fastest, Most Accurate</i><br/>
							<i className="text-6xl font-bold text-gray-600">Way to Close Your Books!</i>
						</div>
					</div>
				</div>
